...
# Add a root route to redirect to docs
@app.get("/")
async def root():
    return {"message": "Welcome to the LangChain Server! Visit /docs to interact with the API"}


# Declare a chain
prompt = ChatPromptTemplate.from_messages(
    [
        ("system", "You're an AI agent that would learn the preferences of the user through chatting and then \
         vote on a DAO proposal on the user's behalf."),
...
class InputChat(BaseModel):
    ...
    human_input: str = Field(
        ...,
        description="Please describe your personal preferences to guide the agent towards your preferred voting choice.",
